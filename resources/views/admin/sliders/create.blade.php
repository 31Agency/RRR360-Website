...
{{--                <label for="video">{{ trans('cruds.slider.fields.video') }}</label>--}}
...
{{--                @endif--}}
{{--                <p class="helper-block">--}}
{{--                    {{ trans('cruds.slider.fields.video_helper') }}--}}
{{--                </p>--}}
{{--            </div>--}}
            ...
            <div class="form-group {{ $errors->has('title_ar') ? 'has-error' : '' }}">
                ...
                <input type="text" id="title_ar" name="title_ar" class="form-control" value="{{ old('title_ar', isset($slider) ? $slider->title_ar : '') }}" required>
                ...
                @endif
                <p class="helper-block">
                    {{ trans('cruds.slider.fields.title_ar_helper') }}
                </p>
            </div>
            ...
            <div class="form-group {{ $errors->has('sub_title_ar') ? 'has-error' : '' }}">
                <label for="sub_title_ar">{{ trans('cruds.slider.fields.sub_title_ar') }}*</label>
                <input type="text" id="sub_title_ar" name="sub_title_ar" class="form-control" value="{{ old('sub_title_ar', isset($slider) ? $slider->sub_title_ar : '') }}" required>
                ...
                @endif
                <p class="helper-block">
                    {{ trans('cruds.slider.fields.sub_title_ar_helper') }}
                </p>
            </div>
...
{{--                <input type="text" id="description_en" name="description_en" class="form-control" value="{{ old('description_en', isset($slider) ? $slider->description_en : '') }}" required>--}}
...
{{--                @endif--}}
{{--                <p class="helper-block">--}}
{{--                    {{ trans('cruds.slider.fields.description_en_helper') }}--}}
{{--                </p>--}}
{{--            </div>--}}
{{--            <div class="form-group {{ $errors->has('description_ar') ? 'has-error' : '' }}">--}}
{{--                <label for="description_ar">{{ trans('cruds.slider.fields.description_ar') }}*</label>--}}
{{--                <input type="text" id="description_ar" name="description_ar" class="form-control" value="{{ old('description_ar', isset($slider) ? $slider->description_ar : '') }}" required>--}}
...
{{--                @endif--}}
{{--                <p class="helper-block">--}}
{{--                    {{ trans('cruds.slider.fields.description_ar_helper') }}--}}
{{--                </p>--}}
{{--            </div>--}}
            <div>
