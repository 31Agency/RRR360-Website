    ...
    <div class="card-body">
        <form action="{{ route("admin.services.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('title_en') ? 'has-error' : '' }}">
                <label for="title_en">{{ trans('cruds.service.fields.title_en') }}*</label>
                <input type="text" id="title_en" name="title_en" class="form-control" value="{{ old('title_en', isset($service) ? $service->title_en : '') }}" required>
    ...
    <script>
        Dropzone.options.photoDropzone = {
            ...
            init: function () {
                ...
                this.options.thumbnail.call(this, file, '{{ $_SERVER['REMOTE_ADDR'] != "127.0.0.1" ? str_replace('localhost/storage', $_SERVER['SERVER_NAME'].'/system/storage/app/public' , $service->photo->getUrl('thumb')) : str_replace('localhost', 'localhost:8000', $service->photo->getUrl('thumb')) }}')
        ...
        Dropzone.options.coverDropzone = {
            ...
            init: function () {
                ...
                this.options.addedfile.call(this, file)
                this.options.thumbnail.call(this, file, '{{ $_SERVER['REMOTE_ADDR'] != "127.0.0.1" ? str_replace('localhost/storage', $_SERVER['SERVER_NAME'].'/system/storage/app/public' , $service->cover->getUrl('thumb')) : str_replace('localhost', 'localhost:8000', $service->cover->getUrl('thumb')) }}')
                file.previewElement.classList.add('dz-complete')
