...
<head>
    ...
    <title>Dashboard - {{ trans('panel.site_title') }} Control Panel</title>
    ...
    {{--    <link href="{{ asset("") }}FrontCP/assets/css/AdminMobile.css" rel="stylesheet">--}}
...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="{{ route('admin.home') }}" class="logo d-flex align-items-center">
            <img src="{{ asset("") }}FrontCP/assets/img/logo.png" alt="Starlet-IT">
            {{--            <span class="d-none d-lg-block">31 Agency</span>--}}
        </a>
        <i class="bi bi-list toggle-sidebar-btn"></i>
    </div><!-- End Logo -->

    <button type="button" onclick="$('#logoutform').submit();" class="SignOutBtn">
...
@include('partials.customize-menu')
...
<main id="main" class="main">
    ...
    <script>
        ...
        function ExportToExcel(type, fn, dl) {
            ...
            return dl ?
                ...
                XLSX.writeFile(wb, fn || ('iHand.' + (type || 'xlsx')));
        }
    ...
    <script>
        @if(isset($_GET['Side']) && $_GET['Side'] == "Arabic")
        $(".Arabic").fadeIn();
        @else
        $(".English").fadeIn();
        @endif
    ...
    <script type="text/javascript">
        function printDiv() {
            var divContents = document.getElementById("tbl_exporttable_to_xls").innerHTML;
