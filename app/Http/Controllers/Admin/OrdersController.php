...
use App\Http\Requests\Destroy\MassDestroyOrderRequest;
...
class OrdersController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.orders.create', compact('vehicle_types'));
    }
    ...
    public function edit(Order $order)
    {
        ...
        return view('admin.orders.edit', compact('order', 'vehicle_types'));
    }
